...
(function($, undefined) {
    ...
    $.fn.show = function(speed, opacity, scale, callback) {
        origShow.call(this);
        ...
        return anim(this, speed, opacity, scale, callback);
    }
    ...
    $.fn.toggle = function(speed, callback) {
        if (speed === undefined || typeof speed == 'boolean') {
            ...
            return this.each(function() {
                var el = $(this);
                // el[(el.css('opacity') == 0 || el.css('display') == 'none') ? 'show' : 'hide'](speed, callback);

                if(el.css('opacity') == 0 || el.css('display') == 'none'){
                    el.show(speed, 1,'0,0',callback);
                }else {
